...
export default function BottomCTA({showCtaAlert, handleClose}:{handleClose: any, showCtaAlert: boolean}) {
    ...
    return (
        <>
            {showCtaAlert && <div className='hidden lg:block bg-gradient-to-r from-[#ae2896] to-[#519af4] fixed w-[70%] left-[8px] bottom-3 p-2 z-20'>
                <div className='flex gap-2 justify-between items-center'>
                    <div className='text-[12px] font-medium'>
                        <p>Preview of Smoothie</p>
                        <p className='line-clamp-2'>Signup to get unlimited songs with occasional ads. No credit card required.</p>
                    </div>
